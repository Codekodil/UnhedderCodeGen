...
public unsafe void 
	...
	Wrapper_Call_TestNative_PointerParent_FillNewChildsShared_4(Native??throw new System.ObjectDisposedException(nameof(PointerParent)),
	...
	return ;}
	[System.Runtime.InteropServices.DllImport("TestNative")]
	private static extern void Wrapper_Call_TestNative_PointerParent_FillNewChildsShared_4
	(IntPtr self,
...
public unsafe void 
	...
	Wrapper_Call_TestNative_PointerParent_FillNewChildsPointer_5(Native??throw new System.ObjectDisposedException(nameof(PointerParent)),
	...
	return ;}
	[System.Runtime.InteropServices.DllImport("TestNative")]
	private static extern void Wrapper_Call_TestNative_PointerParent_FillNewChildsPointer_5
	(IntPtr self,
	IntPtr children_,int children_Size
	);
...
public unsafe void 
	...
	Wrapper_Call_TestNative_PointerParent_FillNewParents_6(Native??throw new System.ObjectDisposedException(nameof(PointerParent)),
	...
	return ;}
	[System.Runtime.InteropServices.DllImport("TestNative")]
	private static extern void Wrapper_Call_TestNative_PointerParent_FillNewParents_6
	(IntPtr self,
...
public unsafe TestNative.PointerChild? 
	...
	var value_result=Wrapper_Call_TestNative_PointerParent_MaybeMakePointer_7(Native??throw new System.ObjectDisposedException(nameof(PointerParent)),
	isNull);
	return (value_result==IntPtr.Zero?null:new TestNative.PointerChild((IntPtr?)value_result));}
	[System.Runtime.InteropServices.DllImport("TestNative")]
	private static extern IntPtr Wrapper_Call_TestNative_PointerParent_MaybeMakePointer_7
	(IntPtr self,
	bool isNull_
	);
...
public unsafe TestNative.PointerChild? 
	...
	var value_result=Wrapper_Call_TestNative_PointerParent_MaybeMakeShared_8(Native??throw new System.ObjectDisposedException(nameof(PointerParent)),
	isNull);
	return (value_result==IntPtr.Zero?null:new TestNative.PointerChild((IntPtr?)value_result));}
	[System.Runtime.InteropServices.DllImport("TestNative")]
	private static extern IntPtr Wrapper_Call_TestNative_PointerParent_MaybeMakeShared_8
	(IntPtr self,
	bool isNull_
	);
...
public unsafe void 
	...
	using var selfLocker = _safeGuard.Lock(nameof(SafeObject));
	fixed(IntPtr*local1080=stackalloc IntPtr[waiters.Length]){var locks1080=new _SafeGuard.DisposableLock?[waiters.Length];for(int i1080=0;i1080<waiters.Length;i1080++)locks1080[i1080]=waiters[i1080]==null?null:waiters[i1080]!._safeGuard.Lock(nameof(waiters));try{for(int i1080=0;i1080<waiters.Length;i1080++)local1080[i1080]=((waiters[i1080])==null?IntPtr.Zero:(waiters[i1080])!.Native??throw new System.ObjectDisposedException(nameof(waiters)));
	Wrapper_Call_TestNative_SafeObject_ConnectAndWaitMultithread_1(Native!.Value,
	(IntPtr)local1080,waiters.Length);
	for(int i1080=0;i1080<waiters.Length;i1080++)if(local1080[i1080]!=waiters[i1080]?.Native)waiters[i1080]=(local1080[i1080]==IntPtr.Zero?null:new TestNative.SafeObject((IntPtr?)local1080[i1080]));}finally{for(int i1080=0;i1080<waiters.Length;i1080++)locks1080[i1080]?.Dispose();}}
	return ;}
	[System.Runtime.InteropServices.DllImport("TestNative")]
